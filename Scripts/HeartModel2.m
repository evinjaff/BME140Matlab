...
plot(Vh(1:800),Ph) 
hold on 
plot( (Vh(1:800)/2)+.098  ,Ph*1.2 + 2)
hold off

% axis([0.1 0.2 0 300])

 title({'Pressure-Volume loop of Normal Heart vs Pressure-Volume Loop of Heart' ;'experiencing Hypovolemia'});
 xlabel('Volume of Left Ventricle (L)')
 ylabel('Pressure of Left Ventricle (mmHg)')
 legend('Normal Heart','Heart Experiencing Hypovolemia')
